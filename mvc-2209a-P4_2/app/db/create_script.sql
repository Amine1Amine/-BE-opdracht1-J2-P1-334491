-- Step: 01
-- Goal: Create a new database Mvc-Oop-2209a-P2
-- **********************************************************************************
-- Version       Date:           Author:                     Description:
-- *******       **********      ****************            ******************
-- 01            10-18-2023      Amine Azzamouri            New
-- **********************************************************************************/

-- Check if the database exists
DROP DATABASE IF EXISTS `Mvc-Oop-2209a-P2`;

-- Create a new Database
CREATE DATABASE IF NOT EXISTS `Mvc-Oop-2209a-P2`;

-- Use database Mvc-Oop-2209a-P2
Use `Mvc-Oop-2209a-P2`;
